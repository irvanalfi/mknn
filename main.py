...
if __name__ == "__main__":
    ...
    df = pandas.read_csv('C:/Users/IRVAN/backendmknn/Upload/smalleuclideandtdt.csv', sep = ',')
    display(df)
    k11_euclidean(df)
    ...
    df1 = pandas.read_csv('C:/Users/IRVAN/backendmknn/Upload/argsmalleuclideandtdt.csv', sep = ',')
    df2 = pandas.read_csv('C:/Users/IRVAN/backendmknn/Upload/traininglabel.csv', sep = ',')
    display(df1)
    display(df2)
    pelabelan(df1, df2)

    df1 = pandas.read_csv('C:/Users/IRVAN/backendmknn/Upload/labelargsmalleuclideandtdt.csv', sep = ',')
    df2 = pandas.read_csv('C:/Users/IRVAN/backendmknn/Upload/traininglabel.csv', sep = ',')
    display(df1)
    display(df2)
    validitas(df1, df2)
