...
if __name__ == "__main__":
    ...
    for j in tqdm(k):
        ...
        df2 = pandas.read_csv('D:/github/mknn/Upload/training.csv', sep=';', header=None)[2]
        df2.to_csv('D:/github/mknn/Upload/label_train.csv', index=False)
        df2 = pandas.read_csv('D:/github/mknn/Upload/testing.csv', sep=';', header=None)[2]
        df2.to_csv('D:/github/mknn/Upload/label_test.csv', index=False)
        display(df1)
        display(df2)
        df2 = pandas.read_csv('D:/github/mknn/Upload/label_train.csv', sep=';')
